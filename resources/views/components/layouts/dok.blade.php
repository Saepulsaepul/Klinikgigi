...
<head>
    ...
    <style>
        ...
        @media (max-width: 1199.98px) {
            ...
            #main-content {
                margin-left: 0px; /* Hilangkan margin di mobile */
            }
        }
    </style>
                ...
                <div class="sidebar-menu px-3">
                    <ul class="menu list-unstyled">
                        ...
                        <li class="sidebar-item">
                            <a wire:navigate href="/dok-dashboard" class="sidebar-link d-flex align-items-center">
                                <i class="bi bi-grid-fill me-2"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a wire:navigate href="/dok-pemeriksaan" class="sidebar-link d-flex align-items-center">
                                <i class="fas fa-calendar me-2"></i>
                                <span> Pemeriksaan </span>
                            </a>
                        </li>
                          <li class="sidebar-item">
                            <a wire:navigate href="/laporan-harian" class="sidebar-link d-flex align-items-center">
